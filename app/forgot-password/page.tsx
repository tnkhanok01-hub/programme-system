        ...
        <div style={{ width: '100%', maxWidth: '400px' }}>
          ...
          <div style={{ background: '#ffffff', border: '1px solid rgba(0,0,0,0.08)', borderRadius: '16px', padding: '28px', display: 'flex', flexDirection: 'column', gap: '16px', boxShadow: '0 4px 24px rgba(0,0,0,0.08)' }}>
            ...
            <form onSubmit={handleResetPassword} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              {/* Email */}
              <div>
                <label style={labelStyle}><Mail size={11} />UTM Email Address <span style={{ color: '#dc2626' }}>*</span></label>
                <input
                  style={inputStyle}
                  type="email"
          ...
          <p style={{ textAlign: 'center', fontSize: '13px', color: '#475569', marginTop: '20px' }}>
            <Link href="/login" style={{ color: '#4f46e5', textDecoration: 'none', fontWeight: 500, display: 'inline-flex', alignItems: 'center', gap: '5px' }}>
